...
async function getData() {
  ...
  let jokeTypeList = result.map((result) => result.type);
  //console.log(jokeTypeList) // returns an array of the joke types

  let  jokeTypeSet = new Set(jokeTypeList); // set should remove duplicates. had to look this up
  ...
  let  jokeTypes = Array.from(jokeTypeSet); //snatched off google
